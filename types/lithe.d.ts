...
declare module '@lithe/dom' {
	...
	export function eventSymbol(module: string, exportName?: string): any; export function capturedEventSymbol(module: string, exportName?: string, captures?: any): any; export function resumeDocument(root?: Document | Element, options?: any): () => void; export function serializeResumeState(options?: any): any; export function getHydrationReport(): { status: string; mismatches: Array<{ message: string; node: string; expected: string | null; at: number }>; fallback: boolean; strict: boolean; at: number };
...
declare module '@lithe/router' {
	...
	export type RouterMiddleware = (context: RouterContext, next: () => Promise<unknown>) => unknown | Promise<unknown>; export interface RouteDefinition { path?: string; name?: string; component?: any; layout?: any; children?: RouteDefinition[]; outlets?: Record<string, any>; load?: (ctx: RouterContext) => unknown | Promise<unknown>; preload?: (ctx?: RouterContext) => unknown | Promise<unknown>; middleware?: RouterMiddleware[]; searchSchema?: any; intercept?: boolean; cache?: boolean | string | number }
	export type Loader<TData = unknown, TContext extends RouterContext = RouterContext> = (context: TContext) => TData | Promise<TData>;
	export type TypedRouteDefinition<TParams extends Record<string, string> = Record<string, string>, TSearch = Record<string, unknown>, TData = unknown> = Omit<RouteDefinition, 'load' | 'preload' | 'component' | 'children'> & { component?: (props: RouterContext & { params: TParams; search: TSearch; data?: TData; children?: any; outlet?: any; router?: any }) => any; load?: Loader<TData, RouterContext & { params: TParams; search: TSearch }>; preload?: Loader<unknown, RouterContext & { params: TParams; search: TSearch }>; children?: RouteDefinition[] };
	...
	export function createRouter(options?: RouterOptions): any; export function createRouter(routes: RouteDefinition[], options?: Omit<RouterOptions, 'routes'>): any; export function group(children: RouteDefinition[], options?: Omit<RouteDefinition, 'children' | 'path'> & { path?: string }): RouteDefinition; export function Link(props: any): any; export function Outlet(props: any): any; export function defineRoutes<T extends readonly RouteDefinition[]>(routes: T): T; export function defineLoader<TData = unknown, TContext extends RouterContext = RouterContext>(loader: Loader<TData, TContext>): Loader<TData, TContext>; export function lazyRoute<TProps = any>(loader: () => Promise<any>, options?: LazyRouteOptions): ((props: TProps) => any) & { preload?: () => Promise<any> }; export function routePath(route: string, params?: Record<string, any>): string; export function prefetchPolicy(): boolean; export function routeManifest(routes: RouteDefinition[]): any[]; export function sharedTransition(id: string): { viewTransitionName: string };
}
...
declare module '@lithe/data' {
	...
	export class QueryClient { constructor(options?: any); fetchQuery<T = any>(options: QueryOptions<T>): Promise<T>; getQueryData<T = any>(key: QueryKey): T | undefined; setQueryData<T = any>(key: QueryKey, updater: T | ((old: T | undefined) => T), options?: any): T | undefined; invalidate(key: QueryKey): void; invalidateTags(tags: string | string[]): void; refetchStale(reason?: string): Promise<void>; dehydrate(): any[]; hydrate(snapshot?: any[]): void; persist(): Promise<void>; restore(): Promise<void>; clear(): void; cancel(key: QueryKey): void }
	export const queryClient: QueryClient; export function defineQuery<T = unknown>(options: QueryOptions<T>): QueryOptions<T>; export function query<T = any>(options: QueryOptions<T>): { readonly data: T | undefined; readonly error: unknown; readonly loading: boolean; readonly stale: boolean; refresh(): Promise<T>; abort(): void; dispose(): void; key(): string }; export function resource<T = any>(fetcher: any, options?: Partial<QueryOptions<T>>): any; export function mutation<TVariables = any, TData = any>(options: any): { mutate(value: TVariables): Promise<TData>; readonly pending: boolean; readonly loading: boolean; readonly error: unknown; readonly data: TData | undefined; reset(): void }; export function defineMutation<TVariables = unknown, TData = unknown>(options: any): any;
...
declare module '@lithe/forms' {
	...
	export function createForm<T extends object = any>(options?: any): any; export function defineForm<T extends object = any>(options: any): any; export function createAdvancedForm<T extends object = any>(options?: any): any; export function AutoForm(props: any): any; export function formDataToObject(formData: FormData): Record<string, any>; export function splitPath(path: string | string[]): Array<string | number>; export function getPath(value: any, path: string | string[]): any; export function setPath(value: any, path: string | string[], next: any): any; export function deletePath(value: any, path: string | string[]): void; export function toJSONSchema(schema: Schema<any>, options?: any): any; export function toOpenAPI(schema: Schema<any>, options?: any): any;
}
...
declare module '@lithe/compiler' {
	...
	export function litheVitePlugin(options?: any): any; export function litheRollupPlugin(options?: any): any; export function litheBabelPlugin(api?: any, options?: any): any; export function litheTailwindPlugin(options?: any): any; export function compileTailwind(css: string, config?: any): Promise<string>; export function generateTailwindCSS(classes: Iterable<string>): string;
}
